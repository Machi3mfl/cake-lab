<div class="container">
	<div class="row form-group"> <!--- PASOS TABS ------------------->
        <div class="col-xs-12">
  ...
  <div class="row setup-content" id="step-1"> <!--  PASO 1 --------------------------->
      ...
      <td>
        ...
        <?php echo $this->Html->image('../files/uploads/'.$img['Upload']['photo_dir'].'/thumb_'.$img['Upload']['photo'],array('id'=>'imageresource') ); ?>
      </td>
      <td>
  ...
  <div class="row setup-content" id="step-2"> <!-- PASO 2 -------------------->
    <div class="col-xs-12 col-md-12">
      ...
      <div class="table-responsive">
        ...
        <thead>
          <tr>
            <th>Archivo</th><th>Cantidad</th><th>Categoria</th><th>Papel</th><th>Tamaño</th><th>Borde</th><th>Precio Unitario</th>
          </tr>
        </thead>
        <tbody>
          <?php if(isset($imgs)) :  {
          ...
          <td id='<?php echo 'precio'.$cant; ?>'  class="text-right"></td>
          </tr>
          <?php
          $cant++;
          endforeach;
