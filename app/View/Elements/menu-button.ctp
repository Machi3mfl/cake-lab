...
<nav class="navbar navbar-fixed-left navbar-minimal animate" role="navigation">
    ...
    <ul class="navbar-menu animate">
            <li>
                <a href="<?php echo Router::url('/').'clientes/home'; ?>" class="animate"  data-toggle="tooltip" data-placement="right" title="Inicio" >
                    <span class="desc animate"> Inicio </span>
                    <span class="fa fa-home"></span>
                </a>
            </li>
            <li>
                <a href="#" data-toggle="tooltip" data-placement="right" title="Atrás"  class="animate">
                    <span  class="desc animate"> Volver </span>
                    <span class="fa fa-reply"></span>
                </a>
            </li>
            <li>
                    <a href="<?php echo Router::url('/').'users/logout'; ?>" class="animate"  data-toggle="tooltip" data-placement="right" title="Salir" >
                            <span class="desc animate"> Cerrar sesión </span>
