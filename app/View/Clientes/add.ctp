...
<div class="col-md-8">
        ...
        <div class='col-md-6'>
            ...
            <div class='form-group'>
                <?php   echo $this->Form->input('piso',array('class'=>'form-control','placeHolder'=>'Ingrese Departamento o piso','label'=>false, 'required'=>true, 'type'=>'text')); ?>
            </div>
            <div class='form-group'>
            ...
            <?php echo $this->Form->end(array('label' => 'Agregar Cliente','class'=>'btn btn-primary pull-right','div' => array('class'=>'form-group') ));?>
        </div>
